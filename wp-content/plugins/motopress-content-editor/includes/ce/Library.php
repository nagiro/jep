...
//                'default' => 'disabled',
            ...
            'bg_video_webm' => array(
                ...
                'label' => $motopressCELang->CERowObjBGVideoWEBMLabel,
                'default' => MPCEShortcode::DEFAULT_VIDEO_BG_WEBM,
                'dependency' => array(
                    'parameter' => 'bg_media_type',
                    'value' => 'video'
                ),
            ...
            'bg_video_mp4' => array(
                'type' => 'media-video',
                'label' => $motopressCELang->CERowObjBGVideoMP4Label,
                'default' => MPCEShortcode::DEFAULT_VIDEO_BG_MP4,
                'dependency' => array(
                    'parameter' => 'bg_media_type',
                    'value' => 'video'
                ),
            ...
            'bg_video_ogg' => array(
                'type' => 'media-video',
                'label' => $motopressCELang->CERowObjBGVideoOGGLabel,
                'default' => MPCEShortcode::DEFAULT_VIDEO_BG_OGG,
                'dependency' => array(
                    'parameter' => 'bg_media_type',
                    'value' => 'video'
                ),
...
//            )
        ...
        $imageObj = new MPCEObject(MPCEShortcode::PREFIX . 'image', $motopressCELang->CEImageObjName, 'image.png', array(
            ...
            'custom_size' => array(
                'type' => 'text',
                'description' => $motopressCELang->CEImageObjCustomSizeLabel,
                'dependency' => array(
                    'parameter' => 'size',
                    'value' => 'custom'
                ),
            ...
            'rel' => array(
                'type' => 'text',
                'label' => $motopressCELang->CEImageObjRelLabel,
                'default' => '',
                'dependency' => array(
                    'parameter' => 'link_type',
                    'value' => 'media_file'
...
*/
        ...
        $socialProfileObj = new MPCEObject(MPCEShortcode::PREFIX . 'social_profile', $motopressCELang->CESocialProfileObjName, 'social-profile.png', array(
            'facebook' => array(
                'type' => 'text',
                'label' => $motopressCELang->CESocialProfileObjFacebookLabel,
                'default' => 'https://www.facebook.com/motopressapp'
            ),
            'google' => array(
                'type' => 'text',
                'label' => $motopressCELang->CESocialProfileObjGoogleLabel,
                'default' => 'https://plus.google.com/+Getmotopress/posts'
            ),
            'twitter' => array(
                'type' => 'text',
                'label' => $motopressCELang->CESocialProfileObjTwitterLabel,
                'default' => 'https://twitter.com/motopressapp'
            ),
            'pinterest' => array(
                'type' => 'text',
                'label' => $motopressCELang->CESocialProfileObjPinterestLabel,
                'default' => 'http://www.pinterest.com/motopress/'
            ),
            'linkedin' => array(
                'type' => 'text',
                'label' => $motopressCELang->CESocialProfileObjLinkedinLabel
            ),
            'flickr' => array(
                'type' => 'text',
                'label' => $motopressCELang->CESocialProfileObjFlickrLabel
            ),
            'vk' => array(
                'type' => 'text',
                'label' => $motopressCELang->CESocialProfileObjVkLabel
            ),
            'delicious' => array(
                'type' => 'text',
                'label' => $motopressCELang->CESocialProfileObjDeliciousLabel
            ),
            'youtube' => array(
                'type' => 'text',
                'label' => $motopressCELang->CESocialProfileObjYoutubeLabel,
                'default' => 'https://www.youtube.com/channel/UCtkDYmIQ5Lv_z8KbjJ2lpFQ'
            ),
            'rss' => array(
                'type' => 'text',
                'label' => $motopressCELang->CESocialProfileObjRssLabel,
