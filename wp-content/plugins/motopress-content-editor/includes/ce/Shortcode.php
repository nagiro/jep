...
//            'parallax_speed' => 5
    ...
    public function motopressSpan($atts, $content = null) {
        ...
        return '<div class="mp-span' . $col . ' motopress-span' . $classes . self::getMarginClasses($margin) . self::getBasicClasses(self::PREFIX . 'span', true) . $mp_style_classes . '"' . $style . '>' . do_shortcode($content) . '</div>';
    }
    ...
    public function motopressSpanInner($atts, $content = null) {
        ...
        return '<div class="mp-span' . $col . ' motopress-span' . $classes . self::getMarginClasses($margin) . self::getBasicClasses(self::PREFIX . 'span_inner', true) . $mp_style_classes . '"' . $style . '>' . do_shortcode($content) . '</div>';
    }
    ...
    public function motopressSpace($atts, $content = null) {
        ...
        if (!empty($mp_style_classes)) $mp_style_classes = ' ' . $mp_style_classes;
        return '<div class="motopress-space-obj' . self::getBasicClasses(self::PREFIX . 'space', true) . $mp_style_classes  . self::getMarginClasses($margin) . '"></div>';
    }
